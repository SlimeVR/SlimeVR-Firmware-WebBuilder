-- CreateEnum
CREATE TYPE "BuildStatus" AS ENUM ('BUILDING', 'DONE', 'FAILED');

-- CreateEnum
CREATE TYPE "BoardType" AS ENUM ('BOARD_SLIMEVR', 'BOARD_SLIMEVR_DEV', 'BOARD_NODEMCU', 'BOARD_WROOM32', 'BOARD_WEMOSD1MINI', 'BOARD_TTGO_TBASE', 'BOARD_ESP01');
...
-- CreateIndex
CREATE UNIQUE INDEX "ImuConfig_firmwareId_key" ON "ImuConfig"("firmwareId");

-- CreateIndex
CREATE UNIQUE INDEX "FirmwareFile_firmwareId_key" ON "FirmwareFile"("firmwareId");

-- CreateIndex
CREATE UNIQUE INDEX "Firmware_id_key" ON "Firmware"("id");

-- AddForeignKey
ALTER TABLE "BoardConfig" ADD CONSTRAINT "BoardConfig_firmwareId_fkey" FOREIGN KEY ("firmwareId") REFERENCES "Firmware"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ImuConfig" ADD CONSTRAINT "ImuConfig_firmwareId_fkey" FOREIGN KEY ("firmwareId") REFERENCES "Firmware"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FirmwareFile" ADD CONSTRAINT "FirmwareFile_firmwareId_fkey" FOREIGN KEY ("firmwareId") REFERENCES "Firmware"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
